...
| 項目 | リポジトリ |
|------|------------|
| このリポ（public） | `sinzy0925/py_keibai_public3` … workflow のみ |
...
- 名前: `py_keibai_public3`
- Visibility: **Public**
- 中身: このフォルダ（`py_keibai_public3/`）の内容をルートに push

```powershell
cd c:\Users\sinzy\py_keibai\py_keibai_public3
git init
git add .
git commit -m "Initial: transcribe workflows for private py_keibai"
git branch -M main
git remote add origin https://github.com/sinzy0925/py_keibai_public3.git
...
### 3. Secrets（`py_keibai_public3` の Settings → Actions）
